    ...
    <section id={SECTION_IDS.howItWorks} className="bg-[var(--surface)] px-4 py-16">
      <div className="mx-auto w-full max-w-[430px]">
          ...
          {howItWorks.map((step, index) => (
            <div key={step.id} className="relative rounded-3xl border border-[var(--border)] bg-[var(--background)] p-5">
              <div className="mb-4 flex items-center gap-3">
                <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-full bg-[var(--primary)] text-sm font-black text-[var(--background)]">
                  {index + 1}
                </div>
        ...
        <div className="mt-6 rounded-3xl bg-[var(--primary)] p-5">
          <p className="text-base font-black leading-7 text-[var(--background)]">
            You set the speed once. ScentMason keeps doing the work in the background.
          </p>
        </div>
      </div>
    </section>
